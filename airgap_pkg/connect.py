"""Native cognis-connect emit for airgap-pkg — forward findings to any platform.

Maps airgap-pkg's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    airgap-pkg ... --format json | airgap-pkg-emit --to stix
    airgap-pkg-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
