...
- Deterministic tar builder (sorted, mtime=0)
- SHA-256 + BOM manifest
- Optional GPG signature verification
- Operator-friendly install/verify for SIPR/JWICS sneakernet workflows
