#!/usr/bin/env sh
# Universal installer for airgap-pkg. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/airgap-pkg.git"
echo "Installing airgap-pkg ..."
